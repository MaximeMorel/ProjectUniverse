...
////////////////////////////////////////////////////////////////////////////////
/*LoggerStringBuf::LoggerStringBuf()
    : std::stringbuf()
{
}
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
LoggerString::LoggerString(const std::string& name, std::ostream& stream)
    : Logger(name), m_buf(stream)
{
    rdbuf(&m_buf);
}
////////////////////////////////////////////////////////////////////////////////
LoggerString::LoggerString(const std::string& name, LoggerStreamBuf& buf)
    : Logger(name), m_buf(buf)
{
    rdbuf(&m_buf);
}
////////////////////////////////////////////////////////////////////////////////
...
LoggerStream::LoggerStream(const std::string& name, std::ostream& stream)
 : Logger(name), m_outStream(stream.rdbuf())
{
}
////////////////////////////////////////////////////////////////////////////////
